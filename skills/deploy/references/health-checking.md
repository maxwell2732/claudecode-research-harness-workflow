---
name: health-check
description: "Environment diagnostics (checking dependencies, configuration, and available features). Use when you want to verify your environment is set up correctly."
allowed-tools: ["Read", "Bash"]
---

# Health Check Skill

A skill for diagnosing whether the environment is correctly set up before using a plugin.
