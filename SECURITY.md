...
tokens, or sensitive local paths in a public issue.

## Supported Versions

Security fixes are shipped in the latest release. Users should update to the
newest `claude-code-harness` version after a security advisory is resolved.
